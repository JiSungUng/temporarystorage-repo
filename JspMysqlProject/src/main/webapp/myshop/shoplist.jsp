	...
	<div style="margin: 30px 30px;">
		...
		<table class="table table-bordered" style="width: 800px;">
			...
			<tr>
				...
				<td><img src="../쇼핑몰사진/<%=dto.getPhoto()%>.jpg" width="60"
					height="50" class="img-circle"> <a
					href="detailpage.jsp?num=<%=dto.getNum()%>"
					style="color: black; text-decoration: none;"> <b><%=dto.getSangpum() %></b>
				</a></td>
